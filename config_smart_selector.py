...
# Smart Pick Selector
# ──────────────────────────────────────────────
ALLOW_SKIP_DAYS = True          # If no picks clear the adjusted threshold, return 0 picks
MIN_ADJUSTED_HIT_PROBABILITY = 0.68
GREEN_LIGHT_THRESHOLD = 0.72
BORDERLINE_THRESHOLD = 0.68
MAX_PICKS_PER_GAME = 1          # Avoid stacking correlated risk in one game
